...
(26,'next_update_check','1763904741');
...
CREATE TABLE `dynamic_flag_mapping` (
  ...
  `encryption_key_id` int(11) NOT NULL DEFAULT 1,
  ...
  KEY `idx_user_challenge_status` (`user_id`,`challenge_id`),
  KEY `idx_team_challenge_status` (`team_id`,`challenge_id`),
...
(3,1,1,2,'147beb838d5fe487a24d361ab166f138e22a93d80d4b967bee3a35291ab2a4d6','gAAAAABpImPiKjV_rb1IAIA2fPmXEl7TPUaJyPNvP16gq9usHC9i5kSWgSnNQK7zc0EXvLjx45Vdtsu-IuH6CwVrmgxI18sHgXJpLFOiiJoZgpxBNVDy_eal8OjtqA5FnJ85DnEVtzME',1,'2025-11-22 14:11:02'),
(13,1,1,2,'b3a6d0295e9601b83bf97b2430585cf2565f37fbdfa7792d91ebec52bfa403dd','gAAAAABpImPi0yvXFlp885i8ZZBi9GPfZZcdgSH7mtWy2a9zOCg7nQ-BB_iUO5MWA_L51drnjTz8NBdDS1sz-WzvXc6KpFG-qKvRXb7nNRZoBRM_6OSMKchY7Nx83hKL0ivkGyVC2bR0',1,'2025-11-22 15:28:41'),
(14,1,1,2,'3dfe97c550d69b08259a6bbea21c94fa1ae88d6b84aa666985a85b5b02211312','gAAAAABpImPiHyM5jbK9m9iQ4TJFh0QPO2z42Cby7PbwEKASSaWh1ylpLY43c1cbxRu7NTrq-MZ6ytYnx6ednvoLaE1OilSQiT1RbmUBcnyw1nBcJkES5-WithHgB0QHmShHHtMll3i3',1,'2025-11-22 15:30:58'),
(16,NULL,1,2,'9ab0b4134a6ddc38b74ea60f0ad7630e7c74f3a2dbae6e7ad6d265561cb97ba0','gAAAAABpImPicfwro_vGy90fS0KFd2iPGQ7BAlN8O7LrbNCBlfnD7fW0qgKPGQ3PJ5t-FWVpjDWilvbHn1tFU2VEZdbzb_PGJgh3fqtMQSP86WeOTu_d-UCoL3_l-ccWktXGDdOYJYTL',1,'2025-11-22 18:46:01');
...
(11,2,1,1,'172.22.0.1','CYBERCOM{testing_6c5dc8_templates_b7634b}','correct','2025-11-22 18:46:30.207582');
...
(2,NULL,'172.22.0.1',1,'2025-11-22 19:26:14.012336',NULL);
...
-- Dump completed on 2025-11-23 13:00:33
